...
kable(data[1:8,1:8], caption="\\#{tbl-tab1} Table 1: Spotify New Variables")
```
# Design Plan

## Study Design

Brooke: Part 1 of this study was based off of Brooke's imagination rather than existing literature. The design. More details regarding the specifics of the dataset can be obtained from TidyTuesday at the following link: https://github.com/rfordatascience/tidytuesday/blob/master/data/2020/2020-01-21/readme.md
...
See the TidyTuesday webpage for a detailed description of how this data was collected and compiled: https://github.com/rfordatascience/tidytuesday/blob/master/data/2020/2020-01-21/readme.md
